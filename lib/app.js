...
lol.prototype._nextTv = function(tvObject){
  ...
  function postShow(err, res, body){
    if (!err && res.statusCode == 200) {
     ...
     if(new Date(episode.airdate) < currentDate) {
       tvBot.postMessageToChannel("Hey buddy. I can't find any upcomming episodes for that. You might wanna check wikipedia and see if it's cancelled. \n Here's the latest episode I know about though")
     }
